...
void AddElement();
void DeleteElement();
double calculateQuantityDisc(int quantity, double price);
double calculateTotalSumDisc(double totalSum);
...
void CreateStorage()
{
    ...
    float price[staticSize]{ 425,559,499,499,445,469,509,399,444,479 };
...
void PrintReceipt()
{
    ...
    double quantityDiscount = calculateQuantityDisc(quantity, totalSum);
    double totalSumDiscount = calculateTotalSumDisc(totalSum);
